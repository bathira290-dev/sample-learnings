...
// closure is imp than interview;

 function outerFunction() {
let count = 0;
function innerFunction(){
    count = count + 1; // outer call chythila inner fun outer+increse to update the function
    console.log(count);//call fun
}

 return innerFunction;// fun to return value to call
 }
